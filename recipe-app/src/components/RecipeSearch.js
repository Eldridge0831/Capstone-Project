    ...
    return (
        <div>
            <Container fluid id="searchContainer">
                ...
                <Row>
                    <Form.Select onChange={(event) => setInputDiet("diet=" + event.target.value)} aria-label="default select example">
                    ...
                    <Form.Select defaultValue="" onChange={handleRequest7} aria-label="default select example">
